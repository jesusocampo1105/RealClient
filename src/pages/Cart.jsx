    ...
    <Helmet title='Carrito'>
      ...
      <Container>
        <Row>
          <Col lg='12'>
            {
              cartItems.length === 0 ? <h3 className='text-center mt-5 mb-5'>El carrito está vacío</h3> : (<Table  bordered responsive hover className='table mt-5 text-center'>
              <thead>
                  <tr>
                    <th>Imagen</th>
                ...
                <tbody>
                  {
                   cartItems.map(item => (<TableRow item={item} key={item.id} />)) 
                  }
